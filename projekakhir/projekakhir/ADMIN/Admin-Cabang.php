...
if (!isset($_SESSION['username'])) {
    ...
    //tampilkan seluruh data cabang
    $select_sql = "SELECT *FROM cabang";


//jika di klik, tampilkan fitur search
if( isset($_POST["cari"])){
...
//jika di klik, tampilkan fitur urut
if( isset($_POST["urut"])){
...
<body>
    <nav>
        <ul>
            ...
            <li><a style="background-color:#1b63ff;" href="#">Info Barang</a>
                <ul>
                    <li><a href="#"><p >Cabang</p></a></li>
                </ul>
            </li>
    ...
    <div class="magin">
        <section class="content">
            <h1 class="title">Kelola Cabang</h1>
            <div class="paraTombol">
                ...
                <div class="tblKiri">
                        ...
                        <a href="CREATE-Cabang.php"><button class="create"><i class="fas fa-plus"></i> Tambah Cabang</button></a>
                </div>
            ...
            <table>
                ...
                <?php foreach ($DATA as $CABANG) : ?>
                    <tr>
                        ...
                        <td ><?= $CABANG["Jumlah_Barang"] ?></td>
                        <td><a href="Admin-Barang.php?Nama=<?=$CABANG["Nama"];?>"><button class="cetak"> <i class="fas fa-shopping-basket"></i></button></a></td>
                        <td><a href="UPDATE-Cabang.php?ID=<?=$CABANG["ID"];?>"onClick="return confirm ('Anda Yakin Ingin Mengubah Cabang <?= $KTP["CABANG"] ?> ?')"><button class="update"><i class="fas fa-pen"> </i></button></a></td>
                        <td><a href="DELETE-Cabang.php?ID=<?=$CABANG["ID"];?>"onClick="return confirm ('Anda Yakin Ingin Menghapus Cabang <?= $KTP["CABANG"] ?> ?')"><button class="delete"><i class="fas fa-trash"></i></button></a></td>     
                    </tr>
                <?php endforeach; ?>
            </table>
