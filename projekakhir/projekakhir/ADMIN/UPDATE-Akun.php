    ...
    <div class="container">
        <form action="" method="POST" class="login-email">
            ...
            <div class="input-group">
                <input type="text" placeholder="Masukan Nama Depan...- "value="<?= $DataUser["username"] ?>"   name="username" required>
            </div>
            <p style="transform: translateX(22px);">Nama Belakang</p>
            <div class="input-group">
                <input type="text" placeholder="Masukan nama Belakang.."value="<?= $DataUser["LastName"] ?>" name="LastName">
            </div>
            <p style="transform: translateX(22px);">Jenis Kelamin</p>
            <div class="input-group">
                <select name="JenisKelamin" value="<?= $DataUser["JenisKelamin"] ?>">
            ...
            <div class="input-group">
                <input type="date" value="<?= $DataUser["Umur"] ?>"    name="Umur" >
            </div>
            <p style="transform: translateX(22px);">Alamat Email</p>
            <div class="input-group">
                <input type="email" placeholder="Masukan Alamat Email.." value="<?= $DataUser["email"] ?>"    name="email" required>
            </div>
            <div class="input-group">
